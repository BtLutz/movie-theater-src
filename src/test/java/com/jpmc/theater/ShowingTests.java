...
public class ShowingTests {
    ...
    void testCalculateTicketPriceWithSpecialMovie() {
        Movie spiderMan = new Movie("Spider-Man: No Way Home", Duration.ofMinutes(90), Money.of(12.5, CURRENCY_UNIT), true);
        Showing showing = new Showing(spiderMan, 5, LocalDateTime.of(2023, 1, 1, 9, 0));
        assertEquals(Money.of(10, CURRENCY_UNIT), showing.calculateTicketPrice());
    }

    @Test
    void testCalculateTicketPriceWithFirstShowing() {
        Movie spiderMan = new Movie("Spider-Man: No Way Home", Duration.ofMinutes(90), Money.of(12.5, CURRENCY_UNIT), false);
        Showing showing = new Showing(spiderMan, 1, LocalDateTime.of(2023, 1, 1, 9, 0));
        assertEquals(Money.of(9.5, CURRENCY_UNIT), showing.calculateTicketPrice());
    }
    ...
    void testCalculateTicketPriceWithSecondShowing() {
        ...
        assertEquals(Money.of(10.5, CURRENCY_UNIT), showing.calculateTicketPrice());
    }
    ...
    void testCalculateTicketPriceWithFirstShowingMatinee() {
        ...
        assertEquals(Money.of(9.38, CURRENCY_UNIT), showing.calculateTicketPrice());
    }
    ...
    void testCalculatePriceWithShowingBefore11() {
        ...
        assertEquals(Money.of(12.5, CURRENCY_UNIT), showing.calculateTicketPrice());
    }
    ...
    void testCalculatePriceWithShowingOnSeventh() {
        ...
        assertEquals(Money.of(11.5, CURRENCY_UNIT), showing.calculateTicketPrice());
    }
}
